...
describe('parseIntent', () => {
  it('should parse simple payment intent', () => {
    const result = parseIntent('send $500 to John in Manila');
  ...
  it('should parse conversational payment intent', () => {
    const result = parseIntent("pay my sister 200 euros, she's in Morocco");
  ...
  it('should parse urgent payment intent', () => {
    const result = parseIntent('I need to send 1000 USDC to my contractor in Nigeria right now, it\'s urgent');
  ...
  it('should handle ambiguous input with low confidence', () => {
    const result = parseIntent('send some money to my friend');
  ...
  it('should parse AI agent style input with reference', () => {
    const result = parseIntent('Execute payment of 750 USD to vendor_id:4421 in PH for invoice INV-2024-089');
